...
<body>
    ...
    <div class="container mt-2">
        <div class="row">
            <?php
        $query = mysqli_query($koneksi, "SELECT * FROM foto INNER JOIN user ON foto.userid
        =user.userid INNER JOIN album ON foto.albumid=album.albumid");
                                    ...
                                    <div class="col-md-4">
                                        <div class="m-2">
                                            <div class="overflow-auto">
                                                ...
                                                <?php
                                                $fotoid = $data['fotoid'];
                                                $komentar = mysqli_query($koneksi, "SELECT * FROM komentarfoto INNER JOIN user ON komentarfoto.userid
    ...
    <input type="text" name="isikomentar" class="form-control" placeholder=
    " silahkan login dulu sebelum komentar" disabled> 
                                                            <div class="input-group-prepend">
                                                                <button type="submit" name="kirimkomentar" class="btn btn-outline-primary">login</button>
                                                            </div>
                                                        </div>
                                                    </form>
                                                </div>
    ...
    <footer class="d-flex justify-content-center border-top mt-3 bg-light fixed-bottom">
        <p>&copy; UKK 2024 | ADE DISTA KASTINA</p>
    </footer>
